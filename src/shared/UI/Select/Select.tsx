...
export const Select: React.FC<SelectI> = (props) => {
    ...
    return (
        <div className="text-base font-proxima">
            {title && <label className="block text-black-700 font-bold mb-3 " htmlFor="custom-select">{title}</label>}
            <div className="relative">
                <div
                    className={`block w-full px-5 py-5 leading-tight ${showList ? 'rounded-t-lg' : 'rounded-lg'} border appearance-none focus:outline-none`}
                    style={{
